...
public class PrivacyAndAbout extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_privacy_and_about);
        ...
        boolean booleanExtra = getIntent().getBooleanExtra(AppMeasurementSdk.ConditionalUserProperty.NAME, true);
    ...
    public void onBackPressed() {
        ...
        ((Button) dialog1.findViewById(R.id.share)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse(PrivacyAndAbout.this.premiumLink));
                PrivacyAndAbout.this.startActivity(intent);
                dialog1.dismiss();
